...
<a href=https://github.com/Ingwie/OpenAVRc_Dev><img width=758 src=documents/openavrc.png></a>

* [**Multiprotocol TX**](https://github.com/stanekTM/TX_Multiprotocol_Stanek) from my fork

<a href=https://github.com/stanekTM/TX_Multiprotocol_Stanek><img width=758 src=documents/opentx_multi_tx.png></a>
...
* Setting a unique address. It is hardcoded into the firmware of RC transmitter OpenAVRc and Multiprotocol TX from my fork
* RF channel setting. It is hardcoded into the firmware of RC transmitter OpenAVRc and Multiprotocol TX from my fork
